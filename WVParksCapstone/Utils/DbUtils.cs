//You'll find it's fairly common practice to create such utility classes
//(sometimes called helper classes). They are the "junk drawer" of our
//software projects. Beware, though, just like everything in software
//development there are positives and negatives to utility classes.
//Resist the temptation to over-generalize. When a particular method
//is only needed in one place, it's better to just make it a private
//method of whatever class it's used in.

using System;
using Microsoft.Data.SqlClient;

namespace WVParksCapstone.Utils
{
    /// <summary>
